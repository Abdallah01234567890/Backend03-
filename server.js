/*
  ...
  Deploy: Render.com
  Frontend URL: https://portpholio-five.vercel.app
  ================================================
*/
...
const allowedOrigins = [
  'https://portpholio-five.vercel.app',  // Vercel frontend yako
  'http://127.0.0.1:5500',               // Live Server (testing local)
  'http://localhost:3000',
];
...
// GET https://backend-1-ufvz.onrender.com/api/health
// ------------------------------------------------
...
// GET https://backend-1-ufvz.onrender.com/api/info
// ------------------------------------------------
...
// ------------------------------------------------
// ROUTE 3: Skills
// GET https://backend-1-ufvz.onrender.com/api/skills
// ------------------------------------------------
...
// ------------------------------------------------
// ROUTE 4: Projects
// GET https://backend-1-ufvz.onrender.com/api/projects
// ------------------------------------------------
    ...
    projects: [
      {
        ...
        liveUrl:      'https://portpholio-five.vercel.app/',
        githubUrl:    null,
        year:         2026,
      },
      {
...
// GET https://backend-1-ufvz.onrender.com/api/education
// ------------------------------------------------
...
// POST https://backend-1-ufvz.onrender.com/api/contact
//
// Frontend inatuma:
//   { name: "...", email: "...", message: "..." }
// ------------------------------------------------
...
// GET https://backend-1-ufvz.onrender.com/
// ------------------------------------------------
app.get('/', (req, res) => {
  res.json({
